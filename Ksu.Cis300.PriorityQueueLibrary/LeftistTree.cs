...
namespace Ksu.Cis300.PriorityQueueLibrary
{
    ...
    {
        /// <summary>
        /// holds the null path length of the current node
        /// </summary>
        ...
        /// <summary>
        /// Gets the shortest distance to a null child
        /// </summary>
        /// <param name="t">Min-Heap Node</param>
        /// <returns>int of distance from null</returns>
